...
- absence_notices: created_by_role, admin_confirmed, admin_confirmed_at, admin_confirmed_by 추가
...
with app.app_context():
    ...
    with db.engine.connect() as conn:
        ...
        if table_exists(conn, 'absence_notices'):
            ...
            print("  absence_notices 테이블 없음 (create_all로 생성됨)")

        # enrollment_schedules 컬럼 추가
        if table_exists(conn, 'enrollment_schedules'):
            ...
            print("  enrollment_schedules 테이블 없음 (create_all로 생성됨)")
